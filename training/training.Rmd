...
```{r plot_predictions}
fig <- far$plot$prob("output/pred_binomial_iCAR.tif",output_file="output/pred_binomial_iCAR.png")
...
```{r plot_future_forest_cover, fig.height=10}
fig <- far$plot$fcc("output/forest_cover_2050.tif",output_file="output/forest_cover_2050.png")
knitr::include_graphics("output/forest_cover_2050.png")
```
